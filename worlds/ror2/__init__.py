...
class RiskOfRainWorld(World):
    ...
    def generate_early(self) -> None:
        ...
        # self.world.classic_mode[self.player].value = False # XXX
        # self.world.environments_as_items[self.player].value = True # XXX

    def generate_basic(self) -> None:
        print("making basic") # XXX
        ...
        if (self.world.environments_as_items[self.player].value):
            ...
            pprint(environment_orderedstages_table) # XXX
            ...
            # self.world.push_precollected(self.create_item("Titanic Plains"))
        ...
        # print("nonjunk_item_count", nonjunk_item_count) # XXX
        # print("junk_item_count", junk_item_count) # XXX
        # print("self.total_revivals", self.total_revivals) # XXX
        # print("len(environments_pool)", len(environments_pool)) # XXX
        # pprint(environments_pool) # XXX
        # print("len(itempool)", len(itempool)) # XXX
        # print("len(world.itempool)", len(self.world.itempool)) # XXX
        # print("len(world.get_locations)", len(self.world.get_locations())) # XXX
        # pprint(self.world.get_locations()) # XXX

    def set_rules(self) -> None:
        set_rules(self.world, self.player)

    def create_regions(self) -> None:
        print("making regions") # XXX
    ...
    def create_item(self, name: str) -> Item:
        ...
        # This should shave down comparions.
            ...
            print(f"{name} is filler") # XXX
        print(f"{name} is {classification:04b}") # XXX
